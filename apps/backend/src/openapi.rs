...
#[openapi(
    paths(
        ...
        crate::modules::users::router::get_user_roles,
        crate::modules::users::router::post_user_role,
        crate::modules::users::router::delete_user_role,
        crate::modules::users::router::create_user,
        crate::modules::auth::router::discord_login,
        crate::modules::auth::router::discord_callback,
        crate::modules::auth::router::pending_tenants,
        ...
        crate::modules::admin::router::get_branding,
        crate::modules::admin::router::update_branding,
        ...
        crate::modules::albion::router::register_by_ign,
        ...
        crate::modules::comps::router::get_build_price,
        crate::modules::comps::router::get_comp_price,
        crate::modules::combat::router::get_dataset,
        crate::modules::combat::router::get_mastery_groups,
        crate::modules::combat::router::post_simulate,
        crate::modules::combat::router::post_item_power,
        crate::modules::combat::router::get_member_item_power,
        crate::modules::combat::router::list_scenarios,
        crate::modules::combat::router::create_scenario,
        crate::modules::combat::router::get_scenario,
        crate::modules::combat::router::update_scenario,
        crate::modules::combat::router::create_scenario_version,
        crate::modules::combat::router::archive_scenario,
        crate::modules::combat::router::unarchive_scenario,
        crate::modules::combat::router::run_scenario,
        crate::modules::combat::router::list_runs,
        crate::modules::combat::router::get_run,
        crate::modules::combat::router::get_calibration,
        ...
        crate::modules::events::router::list_event_revisions,
        ...
        crate::modules::events::router::cancel_event,
        crate::modules::events::router::uncancel_event,
        ...
        crate::modules::regear::router::get_self_service_events,
        crate::modules::regear::router::create_self_service_request,
        ...
        crate::modules::platform::router::list_tenants,
        crate::modules::platform::router::create_tenant,
        crate::modules::platform::router::get_tenant,
        crate::modules::platform::router::patch_tenant,
        crate::modules::platform::router::list_catalog,
        crate::modules::platform::router::list_ranks,
        crate::modules::platform::router::create_rank,
        crate::modules::platform::router::patch_rank,
        crate::modules::platform::router::delete_rank,
        crate::modules::platform::router::put_rank_features,
        crate::modules::platform::router::get_features,
        crate::modules::platform::router::put_features,
        crate::modules::platform::router::list_admins,
        crate::modules::platform::router::assign_admin,
        crate::modules::platform::router::revoke_admin,
        crate::modules::platform::router::reload_admins,
        crate::modules::platform::public::tenant_status,
        crate::modules::platform::public::register_tenant,
        crate::modules::platform::public::albion_search,
        crate::modules::platform::public::attachable_guilds,
        crate::modules::platform::public::my_alliance_context,
        crate::modules::platform::public::list_alliance_members,
        crate::modules::platform::public::patch_alliance_member,
        crate::modules::platform::public::accept_alliance_member,
        crate::modules::alliance_share::router::create_share,
        crate::modules::alliance_share::router::get_build_share,
        crate::modules::alliance_share::router::unshare_build,
        crate::modules::alliance_share::router::get_comp_share,
        crate::modules::alliance_share::router::unshare_comp,
        crate::modules::alliance_share::router::get_split_share,
        crate::modules::alliance_share::router::unshare_split,
        crate::modules::enemies::router::list_enemy_guilds,
        crate::modules::enemies::router::get_enemy_guild,
        crate::modules::enemies::router::list_enemy_players,
        crate::modules::enemies::router::get_enemy_player,
        crate::modules::fingerprints::router::list_fingerprints,
        crate::modules::fingerprints::router::get_fingerprint,
        crate::modules::fingerprints::router::get_build_observations,
        crate::modules::fingerprints::router::meta,
        crate::modules::economy::router::get_battle_economy,
        crate::modules::economy::router::get_fight_economy,
        crate::modules::economy::router::get_event_economy,
        crate::modules::fight_analytics::router::get_fight_analytics,
        crate::modules::attention::router::get_attention_findings,
        crate::modules::fights::get_fight_backfill_issues,
        crate::modules::intel::router::scout_snapshots_backfill,
    ),
    components(
        schemas(
            ...
            crate::modules::auth::service::TenantChoice,
            crate::modules::auth::service::RegisterableGuild,
            ...
            crate::modules::bank::models::GuildBalanceBreakdown,
            ...
            crate::modules::bank::models::RejectWithdrawalRequest,
            ...
            crate::modules::albion::router::RegisterByIgnRequest,
            ...
            crate::modules::combat::models::MasteryGroupsView,
            crate::modules::combat::models::SimulateRequest,
            crate::modules::combat::models::SimulateView,
            crate::modules::combat::sim::AttackerStyle,
            crate::modules::combat::sim::DeclaredCast,
            crate::modules::combat::sim::SideCounts,
            crate::modules::combat::sim::CastOutcome,
            crate::modules::combat::sim::ResolvedAttributeChange,
            crate::modules::combat::sim::ResolvedCrowdControl,
            crate::modules::combat::sim::BurstResult,
            crate::modules::combat::spell::EffectSide,
            ...
            crate::modules::combat::models::CompReadinessView,
            crate::modules::combat::models::ReadinessObservation,
            crate::modules::combat::models::ScenarioDefinition,
            crate::modules::combat::models::CreateScenarioRequest,
            crate::modules::combat::models::UpdateScenarioRequest,
            crate::modules::combat::models::ScenarioSummary,
            crate::modules::combat::models::ScenarioVersionRef,
            crate::modules::combat::models::ScenarioDetail,
            crate::modules::combat::models::RunSummary,
            crate::modules::combat::models::RunDetail,
            crate::modules::combat::scenario::Side,
            crate::modules::combat::scenario::UnitGroup,
            crate::modules::combat::scenario::DeclaredCast,
            crate::modules::combat::scenario::UnitOutcome,
            crate::modules::combat::scenario::ResolvedCastLog,
            crate::modules::combat::scenario::ScenarioResult,
            crate::responses::ApiResponseScenarioDetail,
            crate::responses::ApiResponseScenarioSummaryList,
            crate::responses::ApiResponseRunDetail,
            crate::responses::ApiResponseRunSummaryList,
            crate::modules::combat::models::CalibrationOutlier,
            crate::modules::combat::models::CalibrationView,
            crate::responses::ApiResponseCalibration,
            ...
            crate::modules::comps::models::ItemPriceRow,
            crate::modules::comps::models::BuildPriceView,
            crate::modules::comps::models::CompBuildPriceRow,
            crate::modules::comps::models::CompPriceView,
            ...
            crate::responses::ApiResponseMasteryGroups,
            crate::responses::ApiResponseSimulate,
            ...
            crate::responses::ApiResponseCompReadinessView,
            ...
            crate::responses::ApiResponseEventRevisionList,
            crate::responses::ApiResponseEventView,
            crate::modules::events::models::EventRevision,
            ...
            crate::modules::regear::models::SelfServiceEventOption,
            crate::modules::regear::models::SelfServiceCompBuildOption,
            crate::modules::regear::models::CreateSelfServiceRegearRequest,
            crate::modules::regear::models::RegearItemOverride,
            crate::modules::regear::status::RegearStatus,
            crate::modules::regear::status::RegearSource,
            ...
            crate::modules::platform::models::TenantView,
            crate::modules::platform::models::CreateTenantRequest,
            crate::modules::platform::models::PatchTenantRequest,
            crate::modules::platform::models::TenantRankView,
            crate::modules::platform::models::CreateRankRequest,
            crate::modules::platform::models::PatchRankRequest,
            crate::modules::platform::models::PutRankFeaturesRequest,
            crate::modules::platform::models::FeatureCatalogItem,
            crate::modules::platform::models::TenantFeatureFlag,
            crate::modules::platform::models::TenantFeaturesView,
            crate::modules::platform::models::PutTenantFeaturesRequest,
            crate::modules::platform::models::PlatformAdminView,
            crate::modules::platform::models::AssignAdminRequest,
            crate::modules::platform::models::RegisterTenantRequest,
            crate::modules::platform::models::TenantStatusView,
            crate::modules::platform::models::AttachableGuildView,
            crate::modules::platform::models::AllianceMemberView,
            crate::modules::platform::models::PatchAllianceMemberRequest,
            crate::modules::platform::models::AllianceContextView,
            crate::modules::alliance_share::models::CreateAllianceShareRequest,
            crate::modules::alliance_share::models::AllianceShareView,
            crate::modules::alliance_share::models::AllianceShareStatusView,
            crate::modules::alliance_share::models::ArtifactType,
            crate::modules::enemies::models::EnemyRollup,
            crate::modules::enemies::models::EnemyGuildSummary,
            crate::modules::enemies::models::EnemyAliasValue,
            crate::modules::enemies::models::EnemyAliasGroup,
            crate::modules::enemies::models::EnemyGuildRosterPlayer,
            crate::modules::enemies::models::WeaponHistogramEntry,
            crate::modules::enemies::models::EnemyGuildDossier,
            crate::modules::enemies::models::EnemyPlayerSummary,
            crate::modules::enemies::models::EnemyPlayerBattleEntry,
            crate::modules::enemies::models::EnemyPlayerDossier,
            crate::pagination::PaginatedEnemyGuildSummary,
            crate::pagination::PaginatedEnemyPlayerSummary,
            crate::responses::ApiResponsePaginatedEnemyGuilds,
            crate::responses::ApiResponseEnemyGuildDossier,
            crate::responses::ApiResponsePaginatedEnemyPlayers,
            crate::responses::ApiResponseEnemyPlayerDossier,
            crate::modules::fingerprints::models::FingerprintRollup,
            crate::modules::fingerprints::models::FingerprintSummary,
            crate::modules::fingerprints::models::FingerprintObservationEntry,
            crate::modules::fingerprints::models::FingerprintDetail,
            crate::modules::fingerprints::models::BuildObservationSummary,
            crate::modules::fingerprints::models::MetaEntry,
            crate::pagination::PaginatedFingerprintSummary,
            crate::responses::ApiResponsePaginatedFingerprints,
            crate::responses::ApiResponseFingerprintDetail,
            crate::modules::economy::models::BattleEconomyView,
            crate::modules::economy::models::FightEconomyView,
            crate::modules::economy::models::EventEconomyView,
            crate::responses::ApiResponseBattleEconomy,
            crate::responses::ApiResponseFightEconomy,
            crate::responses::ApiResponseEventEconomy,
            crate::responses::ApiResponseBuildObservationSummary,
            crate::responses::ApiResponseMetaEntries,
            crate::modules::fight_analytics::service::FightAnalyticsView,
            crate::modules::fight_analytics::service::FightStatsView,
            crate::responses::ApiResponseFightAnalytics,
            crate::modules::attention::service::AttentionFindingView,
            crate::responses::ApiResponseAttentionFindingList,
            crate::modules::fights::FightBackfillIssueView,
            crate::responses::ApiResponseFightBackfillIssueList,
            crate::modules::intel::auto_scout::BackfillOutcome,
            crate::responses::ApiResponseScoutBackfillOutcome,
        )
    ),
    tags(
        ...
        (name = "enemies", description = "Enemy guild/player dossiers built from battle evidence: identity, alias history, battle-derived tallies, rosters and weapon histograms. A drill-down of intel, gated on the same feature key."),
        (name = "fingerprints", description = "Equipment identity built from battle evidence: immutable, deduplicated equipment fingerprints matched at most once against the internal build catalog, browsable by fingerprint or by build, plus a per-side current-meta ranking. A drill-down of intel, gated on the same feature key."),
        (name = "economy", description = "The economic bridge between combat evidence and money: per-battle/fight trade indicators computed from `battle_loss_estimates`, and the real per-event P&L built entirely from the declared ledger (`splits`, `regear_deaths`). Income is always declared, never inferred from combat. A drill-down of battle/fight evidence, gated on the same feature key."),
        (name = "fight_analytics", description = "Persisted per-fight outcome and stats rollup, recomputed eagerly on battle hydration and manual Fight merge/split/move. `enemy_*` figures are trade/observation indicators only, never income. A drill-down of battle/fight evidence, gated on the same feature key."),
        (name = "fights", description = "Read-only canonical Fight API: persisted fights grouped from one or more AlbionBB battles, with manual merge/split/move tools and grouping-review diagnostics."),
        (name = "attention", description = "Deterministic, versioned rules answering \"what's wrong\" instead of leaving an officer to infer it from totals. Recomputed synchronously on every read; a finding disappears once its condition stops holding. A drill-down of intel, gated on the same feature key."),
        ...
        (name = "alliance", description = "Publish a guild artifact snapshot into the alliance tenant schema. Called on the guild session; the copy appears on the alliance tenant's existing list endpoints."),
        (name = "platform", description = "Control-plane operators: register and suspend tenants, toggle feature flags, and assign platform SuperAdmin. Requires a platform role; not tenant-scoped."),
