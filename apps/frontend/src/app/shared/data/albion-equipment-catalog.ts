...
const ALBION_ITEM_DISPLAY_NAMES: Readonly<Record<string, string>> = {
  ...
  OFF_SHIELD: 'Shield',
  OFF_TOME_CRYSTAL: 'Cryptcandle',
  OFF_TALISMAN_AVALON: 'Sacred Scepter',
  OFF_JESTERCANE_HELL: 'Muisak',
  CAPE: 'Cape',
  ...
  CAPEITEM_SMUGGLER: "Smuggler's Cape",
  ...
  HEAD_PLATE_SET2: 'Guardian Helmet',
  ARMOR_PLATE_SET2: 'Guardian Armor',
  SHOES_PLATE_SET2: 'Guardian Boots',
  HEAD_PLATE_SET3: 'Knight Helmet',
  ARMOR_PLATE_SET3: 'Knight Armor',
  SHOES_PLATE_SET3: 'Knight Boots',
  ...
  HEAD_GATHERER_FIBER: "Harvester's Cap",
  ARMOR_GATHERER_FIBER: "Harvester's Garb",
  SHOES_GATHERER_FIBER: "Harvester's Workboots",
  HEAD_GATHERER_HIDE: "Skinner's Cap",
  ARMOR_GATHERER_HIDE: "Skinner's Garb",
  SHOES_GATHERER_HIDE: "Skinner's Workboots",
  HEAD_GATHERER_ORE: "Miner's Cap",
  ARMOR_GATHERER_ORE: "Miner's Garb",
  SHOES_GATHERER_ORE: "Miner's Workboots",
  HEAD_GATHERER_ROCK: "Quarrier's Cap",
  ARMOR_GATHERER_ROCK: "Quarrier's Garb",
  SHOES_GATHERER_ROCK: "Quarrier's Workboots",
  HEAD_GATHERER_WOOD: "Lumberjack's Cap",
  ARMOR_GATHERER_WOOD: "Lumberjack's Garb",
  SHOES_GATHERER_WOOD: "Lumberjack's Workboots",
  HEAD_GATHERER_FISH: "Fisherman's Cap",
  ARMOR_GATHERER_FISH: "Fisherman's Garb",
  SHOES_GATHERER_FISH: "Fisherman's Workboots",

  MEAL_PIE: 'Pork Pie',
  MEAL_PIE_FISH: 'Avalonian Pork Pie',
  MEAL_OMELETTE: 'Chicken Omelette',
  MEAL_OMELETTE_FISH: 'Avalonian Chicken Omelette',
  MEAL_OMELETTE_AVALON: 'Avalonian Chicken Omelette',
  MEAL_STEW: 'Beef Stew',
  MEAL_STEW_FISH: 'Avalonian Beef Stew',
  MEAL_STEW_AVALON: 'Avalonian Beef Stew',
  MEAL_SANDWICH: 'Goose Sandwich',
  MEAL_SANDWICH_FISH: 'Avalonian Goose Sandwich',
  MEAL_SANDWICH_AVALON: 'Avalonian Goose Sandwich',
  MEAL_ROAST: 'Pork Roast',
  MEAL_ROAST_FISH: 'Avalonian Pork Roast',
  POTION_HEAL: 'Healing Potion',
  POTION_ENERGY: 'Energy Potion',
  POTION_REVIVE: 'Revive Potion',
  POTION_STONESKIN: 'Resistance Potion',
  POTION_SLOWFIELD: 'Sticky Potion',
  POTION_MOB_RESET: 'Calming Potion',
  POTION_CLEANSE2: 'Cleansing Potion',
  POTION_ACID: 'Acid Potion',
  POTION_BERSERK: 'Berserk Potion',
  POTION_LAVA: 'Hellfire Potion',
  POTION_GATHER: 'Gathering Potion',
  POTION_TORNADO: 'Tornado in a Bottle',
